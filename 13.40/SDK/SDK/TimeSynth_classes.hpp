...
public:
	...
	TMulticastInlineDelegate<void(float SynthPlaybackTimeSeconds)> OnPlaybackTime;                   // 0x0710(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_750[0x9E0];                                    // 0x0750(0x09E0)(Fixing Struct Size After Last Property [ Dumper-8 ])
