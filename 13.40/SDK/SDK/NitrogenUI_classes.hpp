...
public:
	...
	uint8                                         Pad_301[0x7];                                      // 0x0301(0x0007)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
public:
	...
	uint8                                         Pad_304[0xC];                                      // 0x0304(0x000C)(Fixing Struct Size After Last Property [ Dumper-8 ])
...
{
public:
	TMulticastInlineDelegate<void()>              OnNitrogenScoreEventDisplayed;                     // 0x0300(0x0010)(Edit, ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnNitrogenScoreEventHidden;                        // 0x0310(0x0010)(Edit, ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
